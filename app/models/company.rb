class Company < ApplicationRecord
  ...
  validates :centre_address, :commencement_date, :lock_in_period, :no_of_seats, :floor_no, :shift_type, :agreement_date, :company_poc_contact, :company_email_address, :lease_expiry_date, presence: true
  validates :company_email_address, format: { with: URI::MailTo::EMAIL_REGEXP, message: "invalid email format" }
  validates :lock_in_period, :no_of_seats, numericality: { greater_than: 0, only_integer: true }
